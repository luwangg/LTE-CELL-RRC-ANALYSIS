...
static int
memb_wt_MAC_Address_r14_constraint_1(asn_TYPE_descriptor_t *td, const void *sptr,
			asn_app_constraint_failed_f *ctfailcb, void *app_key) {
...
static asn_per_constraints_t asn_PER_memb_wt_MAC_Address_r14_constr_5 GCC_NOTUSED = {
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
...
static asn_TYPE_member_t asn_MBR_LWA_Config_r13_1[] = {
	...
	{ ATF_POINTER, 1, offsetof(struct LWA_Config_r13, wt_MAC_Address_r14),
		...
		memb_wt_MAC_Address_r14_constraint_1,
		&asn_PER_memb_wt_MAC_Address_r14_constr_5,
		0,
		"wt-MAC-Address-r14"
		},
};
static int asn_MAP_LWA_Config_r13_oms_1[] = { 0, 1, 2 };
