...
static int
makeBeforeBreakSCG_Req_r14_2_constraint(asn_TYPE_descriptor_t *td, const void *sptr,
 ...
 */
static void
makeBeforeBreakSCG_Req_r14_2_inherit_TYPE_descriptor(asn_TYPE_descriptor_t *td) {
...
static void
makeBeforeBreakSCG_Req_r14_2_free(asn_TYPE_descriptor_t *td,
		void *struct_ptr, int contents_only) {
	makeBeforeBreakSCG_Req_r14_2_inherit_TYPE_descriptor(td);
	td->free_struct(td, struct_ptr, contents_only);
}

static int
makeBeforeBreakSCG_Req_r14_2_print(asn_TYPE_descriptor_t *td, const void *struct_ptr,
...
makeBeforeBreakSCG_Req_r14_2_decode_ber(asn_codec_ctx_t *opt_codec_ctx, asn_TYPE_descriptor_t *td,
...
makeBeforeBreakSCG_Req_r14_2_encode_der(asn_TYPE_descriptor_t *td,
...
static asn_dec_rval_t
makeBeforeBreakSCG_Req_r14_2_decode_xer(asn_codec_ctx_t *opt_codec_ctx, asn_TYPE_descriptor_t *td,
...
static asn_enc_rval_t
makeBeforeBreakSCG_Req_r14_2_encode_xer(asn_TYPE_descriptor_t *td, void *structure,
...
static asn_dec_rval_t
makeBeforeBreakSCG_Req_r14_2_decode_uper(asn_codec_ctx_t *opt_codec_ctx, asn_TYPE_descriptor_t *td,
...
static asn_enc_rval_t
makeBeforeBreakSCG_Req_r14_2_encode_uper(asn_TYPE_descriptor_t *td,
...
static asn_per_constraints_t asn_PER_type_makeBeforeBreakSCG_Req_r14_constr_2 GCC_NOTUSED = {
	{ APC_CONSTRAINED,	 0,  0,  0,  0 }	/* (0..0) */,
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	0, 0	/* No PER value map */
};
static asn_INTEGER_enum_map_t asn_MAP_makeBeforeBreakSCG_Req_r14_value2enum_2[] = {
	{ 0,	4,	"true" }
};
static unsigned int asn_MAP_makeBeforeBreakSCG_Req_r14_enum2value_2[] = {
	0	/* true(0) */
};
static asn_INTEGER_specifics_t asn_SPC_makeBeforeBreakSCG_Req_r14_specs_2 = {
...
static ber_tlv_tag_t asn_DEF_makeBeforeBreakSCG_Req_r14_tags_2[] = {
...
asn_TYPE_descriptor_t asn_DEF_makeBeforeBreakSCG_Req_r14_2 = {
	...
	"makeBeforeBreakSCG-Req-r14",
	makeBeforeBreakSCG_Req_r14_2_free,
	makeBeforeBreakSCG_Req_r14_2_print,
	makeBeforeBreakSCG_Req_r14_2_constraint,
	makeBeforeBreakSCG_Req_r14_2_decode_ber,
	makeBeforeBreakSCG_Req_r14_2_encode_der,
	makeBeforeBreakSCG_Req_r14_2_decode_xer,
	makeBeforeBreakSCG_Req_r14_2_encode_xer,
	makeBeforeBreakSCG_Req_r14_2_decode_uper,
	makeBeforeBreakSCG_Req_r14_2_encode_uper,
...
static asn_TYPE_member_t asn_MBR_SCG_ConfigInfo_v1430_IEs_1[] = {
...
static int asn_MAP_SCG_ConfigInfo_v1430_IEs_oms_1[] = { 0, 1, 2 };
static ber_tlv_tag_t asn_DEF_SCG_ConfigInfo_v1430_IEs_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static asn_TYPE_tag2member_t asn_MAP_SCG_ConfigInfo_v1430_IEs_tag2el_1[] = {
...
static asn_SEQUENCE_specifics_t asn_SPC_SCG_ConfigInfo_v1430_IEs_specs_1 = {
