...
static asn_TYPE_member_t asn_MBR_AB_ConfigPLMN_NB_r13_1[] = {
...
static int asn_MAP_AB_ConfigPLMN_NB_r13_oms_1[] = { 0 };
static ber_tlv_tag_t asn_DEF_AB_ConfigPLMN_NB_r13_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static asn_TYPE_tag2member_t asn_MAP_AB_ConfigPLMN_NB_r13_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 } /* ab-Config-r13 */
};
static asn_SEQUENCE_specifics_t asn_SPC_AB_ConfigPLMN_NB_r13_specs_1 = {
