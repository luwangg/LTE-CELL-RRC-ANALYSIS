...
static asn_TYPE_member_t asn_MBR_UDT_RestrictingPerPLMN_r13_1[] = {
...
static int asn_MAP_UDT_RestrictingPerPLMN_r13_oms_1[] = { 1 };
static ber_tlv_tag_t asn_DEF_UDT_RestrictingPerPLMN_r13_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static asn_TYPE_tag2member_t asn_MAP_UDT_RestrictingPerPLMN_r13_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* plmn-IdentityIndex-r13 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 } /* udt-Restricting-r13 */
};
static asn_SEQUENCE_specifics_t asn_SPC_UDT_RestrictingPerPLMN_r13_specs_1 = {
