...
static int
rai_Activation_r14_20_constraint(asn_TYPE_descriptor_t *td, const void *sptr,
			asn_app_constraint_failed_f *ctfailcb, void *app_key) {
	/* Replace with underlying type checker */
	td->check_constraints = asn_DEF_NativeEnumerated.check_constraints;
	return td->check_constraints(td, sptr, ctfailcb, app_key);
 ...
 */
static void
rai_Activation_r14_20_inherit_TYPE_descriptor(asn_TYPE_descriptor_t *td) {
	td->free_struct    = asn_DEF_NativeEnumerated.free_struct;
	td->print_struct   = asn_DEF_NativeEnumerated.print_struct;
	td->check_constraints = asn_DEF_NativeEnumerated.check_constraints;
	td->ber_decoder    = asn_DEF_NativeEnumerated.ber_decoder;
...
static void
rai_Activation_r14_20_free(asn_TYPE_descriptor_t *td,
		void *struct_ptr, int contents_only) {
	rai_Activation_r14_20_inherit_TYPE_descriptor(td);
	td->free_struct(td, struct_ptr, contents_only);
}

static int
rai_Activation_r14_20_print(asn_TYPE_descriptor_t *td, const void *struct_ptr,
		int ilevel, asn_app_consume_bytes_f *cb, void *app_key) {
	rai_Activation_r14_20_inherit_TYPE_descriptor(td);
	return td->print_struct(td, struct_ptr, ilevel, cb, app_key);
}
...
static asn_dec_rval_t
rai_Activation_r14_20_decode_ber(asn_codec_ctx_t *opt_codec_ctx, asn_TYPE_descriptor_t *td,
		void **structure, const void *bufptr, size_t size, int tag_mode) {
	rai_Activation_r14_20_inherit_TYPE_descriptor(td);
	return td->ber_decoder(opt_codec_ctx, td, structure, bufptr, size, tag_mode);
}
...
static asn_enc_rval_t
rai_Activation_r14_20_encode_der(asn_TYPE_descriptor_t *td,
		void *structure, int tag_mode, ber_tlv_tag_t tag,
		asn_app_consume_bytes_f *cb, void *app_key) {
	rai_Activation_r14_20_inherit_TYPE_descriptor(td);
	return td->der_encoder(td, structure, tag_mode, tag, cb, app_key);
...
static asn_dec_rval_t
rai_Activation_r14_20_decode_xer(asn_codec_ctx_t *opt_codec_ctx, asn_TYPE_descriptor_t *td,
		void **structure, const char *opt_mname, const void *bufptr, size_t size) {
	rai_Activation_r14_20_inherit_TYPE_descriptor(td);
	return td->xer_decoder(opt_codec_ctx, td, structure, opt_mname, bufptr, size);
}
...
static asn_enc_rval_t
rai_Activation_r14_20_encode_xer(asn_TYPE_descriptor_t *td, void *structure,
		int ilevel, enum xer_encoder_flags_e flags,
		asn_app_consume_bytes_f *cb, void *app_key) {
	rai_Activation_r14_20_inherit_TYPE_descriptor(td);
	return td->xer_encoder(td, structure, ilevel, flags, cb, app_key);
...
static asn_dec_rval_t
rai_Activation_r14_20_decode_uper(asn_codec_ctx_t *opt_codec_ctx, asn_TYPE_descriptor_t *td,
		asn_per_constraints_t *constraints, void **structure, asn_per_data_t *per_data) {
	rai_Activation_r14_20_inherit_TYPE_descriptor(td);
	return td->uper_decoder(opt_codec_ctx, td, constraints, structure, per_data);
}
...
static asn_enc_rval_t
rai_Activation_r14_20_encode_uper(asn_TYPE_descriptor_t *td,
		asn_per_constraints_t *constraints,
		void *structure, asn_per_outp_t *per_out) {
	rai_Activation_r14_20_inherit_TYPE_descriptor(td);
	return td->uper_encoder(td, constraints, structure, per_out);
...
static int
drx_Cycle_v1430_26_constraint(asn_TYPE_descriptor_t *td, const void *sptr,
			asn_app_constraint_failed_f *ctfailcb, void *app_key) {
	/* Replace with underlying type checker */
	td->check_constraints = asn_DEF_NativeEnumerated.check_constraints;
	return td->check_constraints(td, sptr, ctfailcb, app_key);
 ...
 */
static void
drx_Cycle_v1430_26_inherit_TYPE_descriptor(asn_TYPE_descriptor_t *td) {
	td->free_struct    = asn_DEF_NativeEnumerated.free_struct;
	td->print_struct   = asn_DEF_NativeEnumerated.print_struct;
	td->check_constraints = asn_DEF_NativeEnumerated.check_constraints;
	td->ber_decoder    = asn_DEF_NativeEnumerated.ber_decoder;
...
static void
drx_Cycle_v1430_26_free(asn_TYPE_descriptor_t *td,
		void *struct_ptr, int contents_only) {
	drx_Cycle_v1430_26_inherit_TYPE_descriptor(td);
	td->free_struct(td, struct_ptr, contents_only);
}

static int
drx_Cycle_v1430_26_print(asn_TYPE_descriptor_t *td, const void *struct_ptr,
		int ilevel, asn_app_consume_bytes_f *cb, void *app_key) {
	drx_Cycle_v1430_26_inherit_TYPE_descriptor(td);
	return td->print_struct(td, struct_ptr, ilevel, cb, app_key);
}
...
static asn_dec_rval_t
drx_Cycle_v1430_26_decode_ber(asn_codec_ctx_t *opt_codec_ctx, asn_TYPE_descriptor_t *td,
		void **structure, const void *bufptr, size_t size, int tag_mode) {
	drx_Cycle_v1430_26_inherit_TYPE_descriptor(td);
	return td->ber_decoder(opt_codec_ctx, td, structure, bufptr, size, tag_mode);
}
...
static asn_enc_rval_t
drx_Cycle_v1430_26_encode_der(asn_TYPE_descriptor_t *td,
		void *structure, int tag_mode, ber_tlv_tag_t tag,
		asn_app_consume_bytes_f *cb, void *app_key) {
	drx_Cycle_v1430_26_inherit_TYPE_descriptor(td);
	return td->der_encoder(td, structure, tag_mode, tag, cb, app_key);
...
static asn_dec_rval_t
drx_Cycle_v1430_26_decode_xer(asn_codec_ctx_t *opt_codec_ctx, asn_TYPE_descriptor_t *td,
		void **structure, const char *opt_mname, const void *bufptr, size_t size) {
	drx_Cycle_v1430_26_inherit_TYPE_descriptor(td);
	return td->xer_decoder(opt_codec_ctx, td, structure, opt_mname, bufptr, size);
}
...
static asn_enc_rval_t
drx_Cycle_v1430_26_encode_xer(asn_TYPE_descriptor_t *td, void *structure,
		int ilevel, enum xer_encoder_flags_e flags,
		asn_app_consume_bytes_f *cb, void *app_key) {
	drx_Cycle_v1430_26_inherit_TYPE_descriptor(td);
	return td->xer_encoder(td, structure, ilevel, flags, cb, app_key);
...
static asn_dec_rval_t
drx_Cycle_v1430_26_decode_uper(asn_codec_ctx_t *opt_codec_ctx, asn_TYPE_descriptor_t *td,
		asn_per_constraints_t *constraints, void **structure, asn_per_data_t *per_data) {
	drx_Cycle_v1430_26_inherit_TYPE_descriptor(td);
	return td->uper_decoder(opt_codec_ctx, td, constraints, structure, per_data);
}
...
static asn_enc_rval_t
drx_Cycle_v1430_26_encode_uper(asn_TYPE_descriptor_t *td,
		asn_per_constraints_t *constraints,
		void *structure, asn_per_outp_t *per_out) {
	drx_Cycle_v1430_26_inherit_TYPE_descriptor(td);
	return td->uper_encoder(td, constraints, structure, per_out);
...
static asn_per_constraints_t asn_PER_type_rai_Activation_r14_constr_20 GCC_NOTUSED = {
	{ APC_CONSTRAINED,	 0,  0,  0,  0 }	/* (0..0) */,
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	0, 0	/* No PER value map */
};
static asn_per_constraints_t asn_PER_type_dataInactivityTimerConfig_r14_constr_22 GCC_NOTUSED = {
	{ APC_CONSTRAINED,	 1,  1,  0,  1 }	/* (0..1) */,
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	0, 0	/* No PER value map */
};
static asn_per_constraints_t asn_PER_type_drx_Cycle_v1430_constr_26 GCC_NOTUSED = {
...
static asn_INTEGER_enum_map_t asn_MAP_rai_Activation_r14_value2enum_20[] = {
	{ 0,	4,	"true" }
};
static unsigned int asn_MAP_rai_Activation_r14_enum2value_20[] = {
	0	/* true(0) */
};
static asn_INTEGER_specifics_t asn_SPC_rai_Activation_r14_specs_20 = {
...
static ber_tlv_tag_t asn_DEF_rai_Activation_r14_tags_20[] = {
...
asn_TYPE_descriptor_t asn_DEF_rai_Activation_r14_20 = {
	"rai-Activation-r14",
	"rai-Activation-r14",
	rai_Activation_r14_20_free,
	rai_Activation_r14_20_print,
	rai_Activation_r14_20_constraint,
	rai_Activation_r14_20_decode_ber,
	rai_Activation_r14_20_encode_der,
	rai_Activation_r14_20_decode_xer,
	rai_Activation_r14_20_encode_xer,
	rai_Activation_r14_20_decode_uper,
	rai_Activation_r14_20_encode_uper,
	0,	/* Use generic outmost tag fetcher */
	...
	&asn_PER_type_rai_Activation_r14_constr_20,
	0, 0,	/* Defined elsewhere */
...
static ber_tlv_tag_t asn_DEF_setup_tags_24[] = {
	(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static asn_TYPE_tag2member_t asn_MAP_setup_tag2el_24[] = {
...
static asn_TYPE_tag2member_t asn_MAP_dataInactivityTimerConfig_r14_tag2el_22[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* release */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 } /* setup */
};
...
asn_TYPE_descriptor_t asn_DEF_dataInactivityTimerConfig_r14_22 = {
	...
	0,	/* No tags (pointer) */
	0,	/* No tags (count) */
	&asn_PER_type_dataInactivityTimerConfig_r14_constr_22,
	asn_MBR_dataInactivityTimerConfig_r14_22,
	2,	/* Elements count */
	&asn_SPC_dataInactivityTimerConfig_r14_specs_22	/* Additional specs */
};

static asn_INTEGER_enum_map_t asn_MAP_drx_Cycle_v1430_value2enum_26[] = {
	{ 0,	6,	"sf1280" },
	{ 1,	6,	"sf2560" },
	{ 2,	6,	"sf5120" },
	{ 3,	7,	"sf10240" }
};
static unsigned int asn_MAP_drx_Cycle_v1430_enum2value_26[] = {
	3,	/* sf10240(3) */
	0,	/* sf1280(0) */
	1,	/* sf2560(1) */
	2	/* sf5120(2) */
};
static asn_INTEGER_specifics_t asn_SPC_drx_Cycle_v1430_specs_26 = {
...
static ber_tlv_tag_t asn_DEF_drx_Cycle_v1430_tags_26[] = {
...
asn_TYPE_descriptor_t asn_DEF_drx_Cycle_v1430_26 = {
	"drx-Cycle-v1430",
	"drx-Cycle-v1430",
	drx_Cycle_v1430_26_free,
	drx_Cycle_v1430_26_print,
	drx_Cycle_v1430_26_constraint,
	drx_Cycle_v1430_26_decode_ber,
	drx_Cycle_v1430_26_encode_der,
	drx_Cycle_v1430_26_decode_xer,
	drx_Cycle_v1430_26_encode_xer,
	drx_Cycle_v1430_26_decode_uper,
	drx_Cycle_v1430_26_encode_uper,
	0,	/* Use generic outmost tag fetcher */
	...
	&asn_PER_type_drx_Cycle_v1430_constr_26,
	0, 0,	/* Defined elsewhere */
...
static asn_TYPE_member_t asn_MBR_MAC_MainConfig_NB_r13_1[] = {
	...
	{ ATF_POINTER, 3, offsetof(struct MAC_MainConfig_NB_r13, rai_Activation_r14),
		(ASN_TAG_CLASS_CONTEXT | (4 << 2)),
		-1,	/* IMPLICIT tag at current level */
	...
	{ ATF_POINTER, 2, offsetof(struct MAC_MainConfig_NB_r13, dataInactivityTimerConfig_r14),
	...
	{ ATF_POINTER, 1, offsetof(struct MAC_MainConfig_NB_r13, drx_Cycle_v1430),
		(ASN_TAG_CLASS_CONTEXT | (6 << 2)),
		-1,	/* IMPLICIT tag at current level */
...
static int asn_MAP_MAC_MainConfig_NB_r13_oms_1[] = { 0, 1, 3, 4, 5, 6 };
