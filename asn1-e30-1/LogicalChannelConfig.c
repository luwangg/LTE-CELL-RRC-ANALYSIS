...
static int
bitRateQueryProhibitTimer_r14_36_constraint(asn_TYPE_descriptor_t *td, const void *sptr,
			asn_app_constraint_failed_f *ctfailcb, void *app_key) {
	/* Replace with underlying type checker */
	td->check_constraints = asn_DEF_NativeEnumerated.check_constraints;
	return td->check_constraints(td, sptr, ctfailcb, app_key);
 ...
 */
static void
bitRateQueryProhibitTimer_r14_36_inherit_TYPE_descriptor(asn_TYPE_descriptor_t *td) {
	td->free_struct    = asn_DEF_NativeEnumerated.free_struct;
	td->print_struct   = asn_DEF_NativeEnumerated.print_struct;
	td->check_constraints = asn_DEF_NativeEnumerated.check_constraints;
	td->ber_decoder    = asn_DEF_NativeEnumerated.ber_decoder;
...
static void
bitRateQueryProhibitTimer_r14_36_free(asn_TYPE_descriptor_t *td,
		void *struct_ptr, int contents_only) {
	bitRateQueryProhibitTimer_r14_36_inherit_TYPE_descriptor(td);
	td->free_struct(td, struct_ptr, contents_only);
}

static int
bitRateQueryProhibitTimer_r14_36_print(asn_TYPE_descriptor_t *td, const void *struct_ptr,
		int ilevel, asn_app_consume_bytes_f *cb, void *app_key) {
	bitRateQueryProhibitTimer_r14_36_inherit_TYPE_descriptor(td);
	return td->print_struct(td, struct_ptr, ilevel, cb, app_key);
}
...
static asn_dec_rval_t
bitRateQueryProhibitTimer_r14_36_decode_ber(asn_codec_ctx_t *opt_codec_ctx, asn_TYPE_descriptor_t *td,
		void **structure, const void *bufptr, size_t size, int tag_mode) {
	bitRateQueryProhibitTimer_r14_36_inherit_TYPE_descriptor(td);
	return td->ber_decoder(opt_codec_ctx, td, structure, bufptr, size, tag_mode);
}
...
static asn_enc_rval_t
bitRateQueryProhibitTimer_r14_36_encode_der(asn_TYPE_descriptor_t *td,
		void *structure, int tag_mode, ber_tlv_tag_t tag,
		asn_app_consume_bytes_f *cb, void *app_key) {
	bitRateQueryProhibitTimer_r14_36_inherit_TYPE_descriptor(td);
	return td->der_encoder(td, structure, tag_mode, tag, cb, app_key);
...
static asn_dec_rval_t
bitRateQueryProhibitTimer_r14_36_decode_xer(asn_codec_ctx_t *opt_codec_ctx, asn_TYPE_descriptor_t *td,
		void **structure, const char *opt_mname, const void *bufptr, size_t size) {
	bitRateQueryProhibitTimer_r14_36_inherit_TYPE_descriptor(td);
	return td->xer_decoder(opt_codec_ctx, td, structure, opt_mname, bufptr, size);
}
...
static asn_enc_rval_t
bitRateQueryProhibitTimer_r14_36_encode_xer(asn_TYPE_descriptor_t *td, void *structure,
		int ilevel, enum xer_encoder_flags_e flags,
		asn_app_consume_bytes_f *cb, void *app_key) {
	bitRateQueryProhibitTimer_r14_36_inherit_TYPE_descriptor(td);
	return td->xer_encoder(td, structure, ilevel, flags, cb, app_key);
...
static asn_dec_rval_t
bitRateQueryProhibitTimer_r14_36_decode_uper(asn_codec_ctx_t *opt_codec_ctx, asn_TYPE_descriptor_t *td,
		asn_per_constraints_t *constraints, void **structure, asn_per_data_t *per_data) {
	bitRateQueryProhibitTimer_r14_36_inherit_TYPE_descriptor(td);
	return td->uper_decoder(opt_codec_ctx, td, constraints, structure, per_data);
}
...
static asn_enc_rval_t
bitRateQueryProhibitTimer_r14_36_encode_uper(asn_TYPE_descriptor_t *td,
		asn_per_constraints_t *constraints,
		void *structure, asn_per_outp_t *per_out) {
	bitRateQueryProhibitTimer_r14_36_inherit_TYPE_descriptor(td);
	return td->uper_encoder(td, constraints, structure, per_out);
...
static asn_per_constraints_t asn_PER_type_bitRateQueryProhibitTimer_r14_constr_36 GCC_NOTUSED = {
	{ APC_CONSTRAINED,	 3,  3,  0,  7 }	/* (0..7) */,
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	0, 0	/* No PER value map */
};
...
static asn_INTEGER_enum_map_t asn_MAP_bitRateQueryProhibitTimer_r14_value2enum_36[] = {
	{ 0,	2,	"s0" },
	{ 1,	6,	"s0dot4" },
	{ 2,	6,	"s0dot8" },
	{ 3,	6,	"s1dot6" },
...
static unsigned int asn_MAP_bitRateQueryProhibitTimer_r14_enum2value_36[] = {
	0,	/* s0(0) */
	1,	/* s0dot4(1) */
	2,	/* s0dot8(2) */
	6,	/* s12(6) */
...
static asn_INTEGER_specifics_t asn_SPC_bitRateQueryProhibitTimer_r14_specs_36 = {
...
static ber_tlv_tag_t asn_DEF_bitRateQueryProhibitTimer_r14_tags_36[] = {
...
asn_TYPE_descriptor_t asn_DEF_bitRateQueryProhibitTimer_r14_36 = {
	...
	"bitRateQueryProhibitTimer-r14",
	bitRateQueryProhibitTimer_r14_36_free,
	bitRateQueryProhibitTimer_r14_36_print,
	bitRateQueryProhibitTimer_r14_36_constraint,
	bitRateQueryProhibitTimer_r14_36_decode_ber,
	bitRateQueryProhibitTimer_r14_36_encode_der,
	bitRateQueryProhibitTimer_r14_36_decode_xer,
	bitRateQueryProhibitTimer_r14_36_encode_xer,
	bitRateQueryProhibitTimer_r14_36_decode_uper,
	bitRateQueryProhibitTimer_r14_36_encode_uper,
	0,	/* Use generic outmost tag fetcher */
	...
	&asn_PER_type_bitRateQueryProhibitTimer_r14_constr_36,
	0, 0,	/* Defined elsewhere */
...
static int asn_MAP_LogicalChannelConfig_oms_1[] = { 0, 1, 2, 3, 4 };
