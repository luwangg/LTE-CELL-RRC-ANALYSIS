...
static asn_per_constraints_t asn_PER_type_RCLWI_Configuration_r13_constr_1 GCC_NOTUSED = {
...
static asn_TYPE_member_t asn_MBR_RCLWI_Configuration_r13_1[] = {
...
static asn_TYPE_tag2member_t asn_MAP_RCLWI_Configuration_r13_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* release */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 } /* setup */
};
static asn_CHOICE_specifics_t asn_SPC_RCLWI_Configuration_r13_specs_1 = {
