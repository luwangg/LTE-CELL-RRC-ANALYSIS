...
static ber_tlv_tag_t asn_DEF_supportedROHC_Profiles_r13_tags_2[] = {
	(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static asn_TYPE_tag2member_t asn_MAP_supportedROHC_Profiles_r13_tag2el_2[] = {
...
static asn_INTEGER_enum_map_t asn_MAP_maxNumberROHC_ContextSessions_r13_value2enum_10[] = {
	{ 0,	3,	"cs2" },
	{ 1,	3,	"cs4" },
	{ 2,	3,	"cs8" },
	{ 3,	4,	"cs12" }
};
static unsigned int asn_MAP_maxNumberROHC_ContextSessions_r13_enum2value_10[] = {
	3,	/* cs12(3) */
	0,	/* cs2(0) */
	1,	/* cs4(1) */
	2	/* cs8(2) */
};
static asn_INTEGER_specifics_t asn_SPC_maxNumberROHC_ContextSessions_r13_specs_10 = {
...
static ber_tlv_tag_t asn_DEF_maxNumberROHC_ContextSessions_r13_tags_10[] = {
	(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
...
static int asn_MAP_PDCP_Parameters_NB_r13_oms_1[] = { 1 };
static ber_tlv_tag_t asn_DEF_PDCP_Parameters_NB_r13_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static asn_TYPE_tag2member_t asn_MAP_PDCP_Parameters_NB_r13_tag2el_1[] = {
