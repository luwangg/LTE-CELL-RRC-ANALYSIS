...
static int
up_CIoT_EPS_Optimisation_r13_2_constraint(asn_TYPE_descriptor_t *td, const void *sptr,
 ...
 */
static void
up_CIoT_EPS_Optimisation_r13_2_inherit_TYPE_descriptor(asn_TYPE_descriptor_t *td) {
...
static void
up_CIoT_EPS_Optimisation_r13_2_free(asn_TYPE_descriptor_t *td,
		void *struct_ptr, int contents_only) {
	up_CIoT_EPS_Optimisation_r13_2_inherit_TYPE_descriptor(td);
	td->free_struct(td, struct_ptr, contents_only);
}

static int
up_CIoT_EPS_Optimisation_r13_2_print(asn_TYPE_descriptor_t *td, const void *struct_ptr,
...
up_CIoT_EPS_Optimisation_r13_2_decode_ber(asn_codec_ctx_t *opt_codec_ctx, asn_TYPE_descriptor_t *td,
...
up_CIoT_EPS_Optimisation_r13_2_encode_der(asn_TYPE_descriptor_t *td,
...
static asn_dec_rval_t
up_CIoT_EPS_Optimisation_r13_2_decode_xer(asn_codec_ctx_t *opt_codec_ctx, asn_TYPE_descriptor_t *td,
...
static asn_enc_rval_t
up_CIoT_EPS_Optimisation_r13_2_encode_xer(asn_TYPE_descriptor_t *td, void *structure,
...
static asn_dec_rval_t
up_CIoT_EPS_Optimisation_r13_2_decode_uper(asn_codec_ctx_t *opt_codec_ctx, asn_TYPE_descriptor_t *td,
...
static asn_enc_rval_t
up_CIoT_EPS_Optimisation_r13_2_encode_uper(asn_TYPE_descriptor_t *td,
...
static int
cp_CIoT_EPS_Optimisation_r13_4_constraint(asn_TYPE_descriptor_t *td, const void *sptr,
			asn_app_constraint_failed_f *ctfailcb, void *app_key) {
	/* Replace with underlying type checker */
	td->check_constraints = asn_DEF_NativeEnumerated.check_constraints;
	return td->check_constraints(td, sptr, ctfailcb, app_key);
 ...
 */
static void
cp_CIoT_EPS_Optimisation_r13_4_inherit_TYPE_descriptor(asn_TYPE_descriptor_t *td) {
	td->free_struct    = asn_DEF_NativeEnumerated.free_struct;
	td->print_struct   = asn_DEF_NativeEnumerated.print_struct;
	td->check_constraints = asn_DEF_NativeEnumerated.check_constraints;
	td->ber_decoder    = asn_DEF_NativeEnumerated.ber_decoder;
...
static void
cp_CIoT_EPS_Optimisation_r13_4_free(asn_TYPE_descriptor_t *td,
		void *struct_ptr, int contents_only) {
	cp_CIoT_EPS_Optimisation_r13_4_inherit_TYPE_descriptor(td);
	td->free_struct(td, struct_ptr, contents_only);
}

static int
cp_CIoT_EPS_Optimisation_r13_4_print(asn_TYPE_descriptor_t *td, const void *struct_ptr,
		int ilevel, asn_app_consume_bytes_f *cb, void *app_key) {
	cp_CIoT_EPS_Optimisation_r13_4_inherit_TYPE_descriptor(td);
	return td->print_struct(td, struct_ptr, ilevel, cb, app_key);
}
...
static asn_dec_rval_t
cp_CIoT_EPS_Optimisation_r13_4_decode_ber(asn_codec_ctx_t *opt_codec_ctx, asn_TYPE_descriptor_t *td,
		void **structure, const void *bufptr, size_t size, int tag_mode) {
	cp_CIoT_EPS_Optimisation_r13_4_inherit_TYPE_descriptor(td);
	return td->ber_decoder(opt_codec_ctx, td, structure, bufptr, size, tag_mode);
}
...
static asn_enc_rval_t
cp_CIoT_EPS_Optimisation_r13_4_encode_der(asn_TYPE_descriptor_t *td,
		void *structure, int tag_mode, ber_tlv_tag_t tag,
		asn_app_consume_bytes_f *cb, void *app_key) {
	cp_CIoT_EPS_Optimisation_r13_4_inherit_TYPE_descriptor(td);
	return td->der_encoder(td, structure, tag_mode, tag, cb, app_key);
...
static asn_dec_rval_t
cp_CIoT_EPS_Optimisation_r13_4_decode_xer(asn_codec_ctx_t *opt_codec_ctx, asn_TYPE_descriptor_t *td,
		void **structure, const char *opt_mname, const void *bufptr, size_t size) {
	cp_CIoT_EPS_Optimisation_r13_4_inherit_TYPE_descriptor(td);
	return td->xer_decoder(opt_codec_ctx, td, structure, opt_mname, bufptr, size);
}
...
static asn_enc_rval_t
cp_CIoT_EPS_Optimisation_r13_4_encode_xer(asn_TYPE_descriptor_t *td, void *structure,
		int ilevel, enum xer_encoder_flags_e flags,
		asn_app_consume_bytes_f *cb, void *app_key) {
	cp_CIoT_EPS_Optimisation_r13_4_inherit_TYPE_descriptor(td);
	return td->xer_encoder(td, structure, ilevel, flags, cb, app_key);
...
static asn_dec_rval_t
cp_CIoT_EPS_Optimisation_r13_4_decode_uper(asn_codec_ctx_t *opt_codec_ctx, asn_TYPE_descriptor_t *td,
		asn_per_constraints_t *constraints, void **structure, asn_per_data_t *per_data) {
	cp_CIoT_EPS_Optimisation_r13_4_inherit_TYPE_descriptor(td);
	return td->uper_decoder(opt_codec_ctx, td, constraints, structure, per_data);
}
...
static asn_enc_rval_t
cp_CIoT_EPS_Optimisation_r13_4_encode_uper(asn_TYPE_descriptor_t *td,
		asn_per_constraints_t *constraints,
		void *structure, asn_per_outp_t *per_out) {
	cp_CIoT_EPS_Optimisation_r13_4_inherit_TYPE_descriptor(td);
	return td->uper_encoder(td, constraints, structure, per_out);
...
static asn_per_constraints_t asn_PER_type_up_CIoT_EPS_Optimisation_r13_constr_2 GCC_NOTUSED = {
	{ APC_CONSTRAINED,	 0,  0,  0,  0 }	/* (0..0) */,
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	0, 0	/* No PER value map */
};
static asn_per_constraints_t asn_PER_type_cp_CIoT_EPS_Optimisation_r13_constr_4 GCC_NOTUSED = {
	{ APC_CONSTRAINED,	 0,  0,  0,  0 }	/* (0..0) */,
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	0, 0	/* No PER value map */
};
...
static asn_INTEGER_enum_map_t asn_MAP_up_CIoT_EPS_Optimisation_r13_value2enum_2[] = {
	{ 0,	4,	"true" }
};
static unsigned int asn_MAP_up_CIoT_EPS_Optimisation_r13_enum2value_2[] = {
	0	/* true(0) */
};
static asn_INTEGER_specifics_t asn_SPC_up_CIoT_EPS_Optimisation_r13_specs_2 = {
...
static ber_tlv_tag_t asn_DEF_up_CIoT_EPS_Optimisation_r13_tags_2[] = {
...
asn_TYPE_descriptor_t asn_DEF_up_CIoT_EPS_Optimisation_r13_2 = {
	...
	"up-CIoT-EPS-Optimisation-r13",
	up_CIoT_EPS_Optimisation_r13_2_free,
	up_CIoT_EPS_Optimisation_r13_2_print,
	up_CIoT_EPS_Optimisation_r13_2_constraint,
	up_CIoT_EPS_Optimisation_r13_2_decode_ber,
	up_CIoT_EPS_Optimisation_r13_2_encode_der,
	up_CIoT_EPS_Optimisation_r13_2_decode_xer,
	up_CIoT_EPS_Optimisation_r13_2_encode_xer,
	up_CIoT_EPS_Optimisation_r13_2_decode_uper,
	up_CIoT_EPS_Optimisation_r13_2_encode_uper,
...
static asn_INTEGER_enum_map_t asn_MAP_cp_CIoT_EPS_Optimisation_r13_value2enum_4[] = {
	{ 0,	4,	"true" }
};
static unsigned int asn_MAP_cp_CIoT_EPS_Optimisation_r13_enum2value_4[] = {
	0	/* true(0) */
};
static asn_INTEGER_specifics_t asn_SPC_cp_CIoT_EPS_Optimisation_r13_specs_4 = {
...
static ber_tlv_tag_t asn_DEF_cp_CIoT_EPS_Optimisation_r13_tags_4[] = {
...
asn_TYPE_descriptor_t asn_DEF_cp_CIoT_EPS_Optimisation_r13_4 = {
	...
	"cp-CIoT-EPS-Optimisation-r13",
	cp_CIoT_EPS_Optimisation_r13_4_free,
	cp_CIoT_EPS_Optimisation_r13_4_print,
	cp_CIoT_EPS_Optimisation_r13_4_constraint,
	cp_CIoT_EPS_Optimisation_r13_4_decode_ber,
	cp_CIoT_EPS_Optimisation_r13_4_encode_der,
	cp_CIoT_EPS_Optimisation_r13_4_decode_xer,
	cp_CIoT_EPS_Optimisation_r13_4_encode_xer,
	cp_CIoT_EPS_Optimisation_r13_4_decode_uper,
	cp_CIoT_EPS_Optimisation_r13_4_encode_uper,
	0,	/* Use generic outmost tag fetcher */
...
static asn_TYPE_member_t asn_MBR_CIOT_OptimisationPLMN_r13_1[] = {
...
static int asn_MAP_CIOT_OptimisationPLMN_r13_oms_1[] = { 0, 1, 2 };
static ber_tlv_tag_t asn_DEF_CIOT_OptimisationPLMN_r13_tags_1[] = {
