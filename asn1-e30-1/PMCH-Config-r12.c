...
static int
mch_SchedulingPeriod_v1430_17_constraint(asn_TYPE_descriptor_t *td, const void *sptr,
			asn_app_constraint_failed_f *ctfailcb, void *app_key) {
	/* Replace with underlying type checker */
	td->check_constraints = asn_DEF_NativeEnumerated.check_constraints;
	return td->check_constraints(td, sptr, ctfailcb, app_key);
 ...
 */
static void
mch_SchedulingPeriod_v1430_17_inherit_TYPE_descriptor(asn_TYPE_descriptor_t *td) {
	td->free_struct    = asn_DEF_NativeEnumerated.free_struct;
	td->print_struct   = asn_DEF_NativeEnumerated.print_struct;
	td->check_constraints = asn_DEF_NativeEnumerated.check_constraints;
	td->ber_decoder    = asn_DEF_NativeEnumerated.ber_decoder;
...
static void
mch_SchedulingPeriod_v1430_17_free(asn_TYPE_descriptor_t *td,
		void *struct_ptr, int contents_only) {
	mch_SchedulingPeriod_v1430_17_inherit_TYPE_descriptor(td);
	td->free_struct(td, struct_ptr, contents_only);
}

static int
mch_SchedulingPeriod_v1430_17_print(asn_TYPE_descriptor_t *td, const void *struct_ptr,
		int ilevel, asn_app_consume_bytes_f *cb, void *app_key) {
	mch_SchedulingPeriod_v1430_17_inherit_TYPE_descriptor(td);
	return td->print_struct(td, struct_ptr, ilevel, cb, app_key);
}
...
static asn_dec_rval_t
mch_SchedulingPeriod_v1430_17_decode_ber(asn_codec_ctx_t *opt_codec_ctx, asn_TYPE_descriptor_t *td,
		void **structure, const void *bufptr, size_t size, int tag_mode) {
	mch_SchedulingPeriod_v1430_17_inherit_TYPE_descriptor(td);
	return td->ber_decoder(opt_codec_ctx, td, structure, bufptr, size, tag_mode);
}
...
static asn_enc_rval_t
mch_SchedulingPeriod_v1430_17_encode_der(asn_TYPE_descriptor_t *td,
		void *structure, int tag_mode, ber_tlv_tag_t tag,
		asn_app_consume_bytes_f *cb, void *app_key) {
	mch_SchedulingPeriod_v1430_17_inherit_TYPE_descriptor(td);
	return td->der_encoder(td, structure, tag_mode, tag, cb, app_key);
...
static asn_dec_rval_t
mch_SchedulingPeriod_v1430_17_decode_xer(asn_codec_ctx_t *opt_codec_ctx, asn_TYPE_descriptor_t *td,
		void **structure, const char *opt_mname, const void *bufptr, size_t size) {
	mch_SchedulingPeriod_v1430_17_inherit_TYPE_descriptor(td);
	return td->xer_decoder(opt_codec_ctx, td, structure, opt_mname, bufptr, size);
}
...
static asn_enc_rval_t
mch_SchedulingPeriod_v1430_17_encode_xer(asn_TYPE_descriptor_t *td, void *structure,
		int ilevel, enum xer_encoder_flags_e flags,
		asn_app_consume_bytes_f *cb, void *app_key) {
	mch_SchedulingPeriod_v1430_17_inherit_TYPE_descriptor(td);
	return td->xer_encoder(td, structure, ilevel, flags, cb, app_key);
...
static asn_dec_rval_t
mch_SchedulingPeriod_v1430_17_decode_uper(asn_codec_ctx_t *opt_codec_ctx, asn_TYPE_descriptor_t *td,
		asn_per_constraints_t *constraints, void **structure, asn_per_data_t *per_data) {
	mch_SchedulingPeriod_v1430_17_inherit_TYPE_descriptor(td);
	return td->uper_decoder(opt_codec_ctx, td, constraints, structure, per_data);
}
...
static asn_enc_rval_t
mch_SchedulingPeriod_v1430_17_encode_uper(asn_TYPE_descriptor_t *td,
		asn_per_constraints_t *constraints,
		void *structure, asn_per_outp_t *per_out) {
	mch_SchedulingPeriod_v1430_17_inherit_TYPE_descriptor(td);
	return td->uper_encoder(td, constraints, structure, per_out);
...
static asn_per_constraints_t asn_PER_type_mch_SchedulingPeriod_v1430_constr_17 GCC_NOTUSED = {
	{ APC_CONSTRAINED,	 1,  1,  0,  1 }	/* (0..1) */,
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	0, 0	/* No PER value map */
};
...
static asn_INTEGER_enum_map_t asn_MAP_mch_SchedulingPeriod_v1430_value2enum_17[] = {
	{ 0,	3,	"rf1" },
	{ 1,	3,	"rf2" }
};
static unsigned int asn_MAP_mch_SchedulingPeriod_v1430_enum2value_17[] = {
	0,	/* rf1(0) */
	1	/* rf2(1) */
};
static asn_INTEGER_specifics_t asn_SPC_mch_SchedulingPeriod_v1430_specs_17 = {
...
static ber_tlv_tag_t asn_DEF_mch_SchedulingPeriod_v1430_tags_17[] = {
...
asn_TYPE_descriptor_t asn_DEF_mch_SchedulingPeriod_v1430_17 = {
	...
	"mch-SchedulingPeriod-v1430",
	mch_SchedulingPeriod_v1430_17_free,
	mch_SchedulingPeriod_v1430_17_print,
	mch_SchedulingPeriod_v1430_17_constraint,
	mch_SchedulingPeriod_v1430_17_decode_ber,
	mch_SchedulingPeriod_v1430_17_encode_der,
	mch_SchedulingPeriod_v1430_17_decode_xer,
	mch_SchedulingPeriod_v1430_17_encode_xer,
	mch_SchedulingPeriod_v1430_17_decode_uper,
	mch_SchedulingPeriod_v1430_17_encode_uper,
	0,	/* Use generic outmost tag fetcher */
	...
	&asn_PER_type_mch_SchedulingPeriod_v1430_constr_17,
	0, 0,	/* Defined elsewhere */
