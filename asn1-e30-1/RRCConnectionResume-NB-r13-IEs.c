...
static int
drb_ContinueROHC_r13_4_constraint(asn_TYPE_descriptor_t *td, const void *sptr,
 ...
 */
static void
drb_ContinueROHC_r13_4_inherit_TYPE_descriptor(asn_TYPE_descriptor_t *td) {
...
static void
drb_ContinueROHC_r13_4_free(asn_TYPE_descriptor_t *td,
		void *struct_ptr, int contents_only) {
	drb_ContinueROHC_r13_4_inherit_TYPE_descriptor(td);
	td->free_struct(td, struct_ptr, contents_only);
}

static int
drb_ContinueROHC_r13_4_print(asn_TYPE_descriptor_t *td, const void *struct_ptr,
...
drb_ContinueROHC_r13_4_decode_ber(asn_codec_ctx_t *opt_codec_ctx, asn_TYPE_descriptor_t *td,
...
drb_ContinueROHC_r13_4_encode_der(asn_TYPE_descriptor_t *td,
...
static asn_dec_rval_t
drb_ContinueROHC_r13_4_decode_xer(asn_codec_ctx_t *opt_codec_ctx, asn_TYPE_descriptor_t *td,
...
static asn_enc_rval_t
drb_ContinueROHC_r13_4_encode_xer(asn_TYPE_descriptor_t *td, void *structure,
...
static asn_dec_rval_t
drb_ContinueROHC_r13_4_decode_uper(asn_codec_ctx_t *opt_codec_ctx, asn_TYPE_descriptor_t *td,
...
static asn_enc_rval_t
drb_ContinueROHC_r13_4_encode_uper(asn_TYPE_descriptor_t *td,
...
static asn_per_constraints_t asn_PER_type_drb_ContinueROHC_r13_constr_4 GCC_NOTUSED = {
	{ APC_CONSTRAINED,	 0,  0,  0,  0 }	/* (0..0) */,
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	0, 0	/* No PER value map */
};
static asn_INTEGER_enum_map_t asn_MAP_drb_ContinueROHC_r13_value2enum_4[] = {
	{ 0,	4,	"true" }
};
static unsigned int asn_MAP_drb_ContinueROHC_r13_enum2value_4[] = {
	0	/* true(0) */
};
static asn_INTEGER_specifics_t asn_SPC_drb_ContinueROHC_r13_specs_4 = {
...
static ber_tlv_tag_t asn_DEF_drb_ContinueROHC_r13_tags_4[] = {
...
asn_TYPE_descriptor_t asn_DEF_drb_ContinueROHC_r13_4 = {
	...
	"drb-ContinueROHC-r13",
	drb_ContinueROHC_r13_4_free,
	drb_ContinueROHC_r13_4_print,
	drb_ContinueROHC_r13_4_constraint,
	drb_ContinueROHC_r13_4_decode_ber,
	drb_ContinueROHC_r13_4_encode_der,
	drb_ContinueROHC_r13_4_decode_xer,
	drb_ContinueROHC_r13_4_encode_xer,
	drb_ContinueROHC_r13_4_decode_uper,
	drb_ContinueROHC_r13_4_encode_uper,
...
static asn_TYPE_member_t asn_MBR_RRCConnectionResume_NB_r13_IEs_1[] = {
...
static int asn_MAP_RRCConnectionResume_NB_r13_IEs_oms_1[] = { 0, 2, 3, 4 };
static ber_tlv_tag_t asn_DEF_RRCConnectionResume_NB_r13_IEs_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static asn_TYPE_tag2member_t asn_MAP_RRCConnectionResume_NB_r13_IEs_tag2el_1[] = {
...
static asn_SEQUENCE_specifics_t asn_SPC_RRCConnectionResume_NB_r13_IEs_specs_1 = {
