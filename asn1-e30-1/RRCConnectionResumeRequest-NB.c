...
static asn_TYPE_member_t asn_MBR_RRCConnectionResumeRequest_NB_1[] = {
...
static ber_tlv_tag_t asn_DEF_RRCConnectionResumeRequest_NB_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static asn_TYPE_tag2member_t asn_MAP_RRCConnectionResumeRequest_NB_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 } /* criticalExtensions */
};
static asn_SEQUENCE_specifics_t asn_SPC_RRCConnectionResumeRequest_NB_specs_1 = {
