...
static asn_per_constraints_t asn_PER_type_BCCH_DL_SCH_MessageType_MBMS_r14_constr_1 GCC_NOTUSED = {
	{ APC_CONSTRAINED,	 1,  1,  0,  1 }	/* (0..1) */,
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	0, 0	/* No PER value map */
};
...
static asn_TYPE_member_t asn_MBR_BCCH_DL_SCH_MessageType_MBMS_r14_1[] = {
...
static asn_TYPE_tag2member_t asn_MAP_BCCH_DL_SCH_MessageType_MBMS_r14_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* c1 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 } /* messageClassExtension */
};
static asn_CHOICE_specifics_t asn_SPC_BCCH_DL_SCH_MessageType_MBMS_r14_specs_1 = {
