...
static int
syncPriority_r14_9_constraint(asn_TYPE_descriptor_t *td, const void *sptr,
 ...
 */
static void
syncPriority_r14_9_inherit_TYPE_descriptor(asn_TYPE_descriptor_t *td) {
...
static void
syncPriority_r14_9_free(asn_TYPE_descriptor_t *td,
		void *struct_ptr, int contents_only) {
	syncPriority_r14_9_inherit_TYPE_descriptor(td);
	td->free_struct(td, struct_ptr, contents_only);
}

static int
syncPriority_r14_9_print(asn_TYPE_descriptor_t *td, const void *struct_ptr,
...
syncPriority_r14_9_decode_ber(asn_codec_ctx_t *opt_codec_ctx, asn_TYPE_descriptor_t *td,
...
syncPriority_r14_9_encode_der(asn_TYPE_descriptor_t *td,
...
static asn_dec_rval_t
syncPriority_r14_9_decode_xer(asn_codec_ctx_t *opt_codec_ctx, asn_TYPE_descriptor_t *td,
...
static asn_enc_rval_t
syncPriority_r14_9_encode_xer(asn_TYPE_descriptor_t *td, void *structure,
...
static asn_dec_rval_t
syncPriority_r14_9_decode_uper(asn_codec_ctx_t *opt_codec_ctx, asn_TYPE_descriptor_t *td,
...
static asn_enc_rval_t
syncPriority_r14_9_encode_uper(asn_TYPE_descriptor_t *td,
...
static asn_per_constraints_t asn_PER_type_syncPriority_r14_constr_9 GCC_NOTUSED = {
...
static asn_INTEGER_enum_map_t asn_MAP_syncPriority_r14_value2enum_9[] = {
	{ 0,	4,	"gnss" },
	{ 1,	3,	"enb" }
};
static unsigned int asn_MAP_syncPriority_r14_enum2value_9[] = {
	1,	/* enb(1) */
	0	/* gnss(0) */
};
static asn_INTEGER_specifics_t asn_SPC_syncPriority_r14_specs_9 = {
...
static ber_tlv_tag_t asn_DEF_syncPriority_r14_tags_9[] = {
...
asn_TYPE_descriptor_t asn_DEF_syncPriority_r14_9 = {
	"syncPriority-r14",
	"syncPriority-r14",
	syncPriority_r14_9_free,
	syncPriority_r14_9_print,
	syncPriority_r14_9_constraint,
	syncPriority_r14_9_decode_ber,
	syncPriority_r14_9_encode_der,
	syncPriority_r14_9_decode_xer,
	syncPriority_r14_9_encode_xer,
	syncPriority_r14_9_decode_uper,
	syncPriority_r14_9_encode_uper,
...
static int asn_MAP_SL_V2X_PreconfigFreqInfo_r14_oms_1[] = { 1, 5, 6, 8, 9 };
