...
static asn_TYPE_member_t asn_MBR_SL_SyncConfigNFreq_r13_1[] = {
	...
	{ ATF_POINTER, 2, offsetof(struct SL_SyncConfigNFreq_r13, syncOffsetIndicator_v1430),
		(ASN_TAG_CLASS_CONTEXT | (3 << 2)),
		-1,	/* IMPLICIT tag at current level */
	...
	{ ATF_POINTER, 1, offsetof(struct SL_SyncConfigNFreq_r13, gnss_Sync_r14),
		(ASN_TAG_CLASS_CONTEXT | (4 << 2)),
		-1,	/* IMPLICIT tag at current level */
...
static int asn_MAP_SL_SyncConfigNFreq_r13_oms_1[] = { 0, 1, 2, 3, 4 };
