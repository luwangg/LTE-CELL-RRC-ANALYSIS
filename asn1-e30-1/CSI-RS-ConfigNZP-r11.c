...
static asn_per_constraints_t asn_PER_type_mbsfn_SubframeConfigList_v1430_constr_26 GCC_NOTUSED = {
	{ APC_CONSTRAINED,	 1,  1,  0,  1 }	/* (0..1) */,
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	0, 0	/* No PER value map */
};
...
static asn_TYPE_tag2member_t asn_MAP_mbsfn_SubframeConfigList_v1430_tag2el_26[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* release */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 } /* setup */
};
...
asn_TYPE_descriptor_t asn_DEF_mbsfn_SubframeConfigList_v1430_26 = {
	...
	0,	/* No tags (pointer) */
	0,	/* No tags (count) */
	&asn_PER_type_mbsfn_SubframeConfigList_v1430_constr_26,
...
static int asn_MAP_CSI_RS_ConfigNZP_r11_oms_1[] = { 5, 6, 7, 8, 9 };
