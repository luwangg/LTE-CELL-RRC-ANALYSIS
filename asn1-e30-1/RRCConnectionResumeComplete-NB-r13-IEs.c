...
static asn_SEQUENCE_specifics_t asn_SPC_nonCriticalExtension_specs_5 = {
	sizeof(struct RRCConnectionResumeComplete_NB_r13_IEs__nonCriticalExtension),
	offsetof(struct RRCConnectionResumeComplete_NB_r13_IEs__nonCriticalExtension, _asn_ctx),
	0,	/* No top level tags */
...
static asn_TYPE_member_t asn_MBR_RRCConnectionResumeComplete_NB_r13_IEs_1[] = {
...
static int asn_MAP_RRCConnectionResumeComplete_NB_r13_IEs_oms_1[] = { 0, 1, 2, 3 };
static ber_tlv_tag_t asn_DEF_RRCConnectionResumeComplete_NB_r13_IEs_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static asn_TYPE_tag2member_t asn_MAP_RRCConnectionResumeComplete_NB_r13_IEs_tag2el_1[] = {
...
static asn_SEQUENCE_specifics_t asn_SPC_RRCConnectionResumeComplete_NB_r13_IEs_specs_1 = {
