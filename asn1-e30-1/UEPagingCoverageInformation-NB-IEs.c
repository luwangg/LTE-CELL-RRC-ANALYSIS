...
static int
memb_npdcch_NumRepetitionPaging_r13_constraint_1(asn_TYPE_descriptor_t *td, const void *sptr,
...
static asn_per_constraints_t asn_PER_memb_npdcch_NumRepetitionPaging_r13_constr_2 GCC_NOTUSED = {
...
static asn_TYPE_member_t asn_MBR_UEPagingCoverageInformation_NB_IEs_1[] = {
...
static int asn_MAP_UEPagingCoverageInformation_NB_IEs_oms_1[] = { 0, 1 };
static ber_tlv_tag_t asn_DEF_UEPagingCoverageInformation_NB_IEs_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static asn_TYPE_tag2member_t asn_MAP_UEPagingCoverageInformation_NB_IEs_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* npdcch-NumRepetitionPaging-r13 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 } /* nonCriticalExtension */
};
static asn_SEQUENCE_specifics_t asn_SPC_UEPagingCoverageInformation_NB_IEs_specs_1 = {
