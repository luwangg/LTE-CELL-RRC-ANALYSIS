...
static asn_TYPE_member_t asn_MBR_IntraFreqCellReselectionInfo_NB_v1350_1[] = {
...
static ber_tlv_tag_t asn_DEF_IntraFreqCellReselectionInfo_NB_v1350_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static asn_TYPE_tag2member_t asn_MAP_IntraFreqCellReselectionInfo_NB_v1350_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 } /* delta-RxLevMin-v1350 */
};
static asn_SEQUENCE_specifics_t asn_SPC_IntraFreqCellReselectionInfo_NB_v1350_specs_1 = {
