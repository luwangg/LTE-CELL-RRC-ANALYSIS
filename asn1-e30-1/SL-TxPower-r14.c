...
static int
memb_txPower_r14_constraint_1(asn_TYPE_descriptor_t *td, const void *sptr,
...
static asn_per_constraints_t asn_PER_memb_txPower_r14_constr_3 GCC_NOTUSED = {
	{ APC_CONSTRAINED,	 7,  7, -41,  31 }	/* (-41..31) */,
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	0, 0	/* No PER value map */
};
static asn_per_constraints_t asn_PER_type_SL_TxPower_r14_constr_1 GCC_NOTUSED = {
	{ APC_CONSTRAINED,	 1,  1,  0,  1 }	/* (0..1) */,
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	0, 0	/* No PER value map */
};
static asn_TYPE_member_t asn_MBR_SL_TxPower_r14_1[] = {
...
static asn_TYPE_tag2member_t asn_MAP_SL_TxPower_r14_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* minusinfinity-r14 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 } /* txPower-r14 */
};
static asn_CHOICE_specifics_t asn_SPC_SL_TxPower_r14_specs_1 = {
