...
static asn_TYPE_member_t asn_MBR_MIMO_CA_ParametersPerBoBC_v1430_1[] = {
...
static int asn_MAP_MIMO_CA_ParametersPerBoBC_v1430_oms_1[] = { 0, 1 };
static ber_tlv_tag_t asn_DEF_MIMO_CA_ParametersPerBoBC_v1430_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static asn_TYPE_tag2member_t asn_MAP_MIMO_CA_ParametersPerBoBC_v1430_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* parametersTM9-v1430 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 } /* parametersTM10-v1430 */
};
static asn_SEQUENCE_specifics_t asn_SPC_MIMO_CA_ParametersPerBoBC_v1430_specs_1 = {
