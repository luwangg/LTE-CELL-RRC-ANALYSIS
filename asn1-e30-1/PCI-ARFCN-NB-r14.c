...
static asn_TYPE_member_t asn_MBR_PCI_ARFCN_NB_r14_1[] = {
...
static int asn_MAP_PCI_ARFCN_NB_r14_oms_1[] = { 1 };
static ber_tlv_tag_t asn_DEF_PCI_ARFCN_NB_r14_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static asn_TYPE_tag2member_t asn_MAP_PCI_ARFCN_NB_r14_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* physCellId-r14 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 } /* carrierFreq-r14 */
};
static asn_SEQUENCE_specifics_t asn_SPC_PCI_ARFCN_NB_r14_specs_1 = {
