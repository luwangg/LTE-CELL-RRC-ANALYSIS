...
static asn_TYPE_member_t asn_MBR_AS_Config_v1320_1[] = {
...
static int asn_MAP_AS_Config_v1320_oms_1[] = { 0, 1 };
static ber_tlv_tag_t asn_DEF_AS_Config_v1320_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static asn_TYPE_tag2member_t asn_MAP_AS_Config_v1320_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* sourceSCellConfigList-r13 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 } /* sourceRCLWI-Configuration-r13 */
};
static asn_SEQUENCE_specifics_t asn_SPC_AS_Config_v1320_specs_1 = {
