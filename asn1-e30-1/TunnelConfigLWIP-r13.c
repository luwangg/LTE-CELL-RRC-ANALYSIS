...
static int
memb_lwip_Counter_r13_constraint_1(asn_TYPE_descriptor_t *td, const void *sptr,
...
static asn_per_constraints_t asn_PER_memb_lwip_Counter_r13_constr_5 GCC_NOTUSED = {
...
static asn_TYPE_member_t asn_MBR_TunnelConfigLWIP_r13_1[] = {
	...
	{ ATF_POINTER, 1, offsetof(struct TunnelConfigLWIP_r13, lwip_Counter_r13),
		...
		memb_lwip_Counter_r13_constraint_1,
		&asn_PER_memb_lwip_Counter_r13_constr_5,
		0,
		"lwip-Counter-r13"
		},
};
