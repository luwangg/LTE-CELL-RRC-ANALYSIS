...
static int
memb_ul_NAS_MAC_r14_constraint_1(asn_TYPE_descriptor_t *td, const void *sptr,
...
static int
memb_ul_NAS_Count_r14_constraint_1(asn_TYPE_descriptor_t *td, const void *sptr,
			asn_app_constraint_failed_f *ctfailcb, void *app_key) {
	const BIT_STRING_t *st = (const BIT_STRING_t *)sptr;
	size_t size;
...
static asn_per_constraints_t asn_PER_memb_ul_NAS_MAC_r14_constr_3 GCC_NOTUSED = {
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	{ APC_CONSTRAINED,	 0,  0,  16,  16 }	/* (SIZE(16..16)) */,
	0, 0	/* No PER value map */
};
static asn_per_constraints_t asn_PER_memb_ul_NAS_Count_r14_constr_4 GCC_NOTUSED = {
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	{ APC_CONSTRAINED,	 0,  0,  5,  5 }	/* (SIZE(5..5)) */,
	0, 0	/* No PER value map */
};
static asn_TYPE_member_t asn_MBR_ReestabUE_Identity_CP_NB_r14_1[] = {
...
static ber_tlv_tag_t asn_DEF_ReestabUE_Identity_CP_NB_r14_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static asn_TYPE_tag2member_t asn_MAP_ReestabUE_Identity_CP_NB_r14_tag2el_1[] = {
...
static asn_SEQUENCE_specifics_t asn_SPC_ReestabUE_Identity_CP_NB_r14_specs_1 = {
