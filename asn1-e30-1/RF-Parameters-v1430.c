...
static int
diffFallbackCombReport_r14_7_constraint(asn_TYPE_descriptor_t *td, const void *sptr,
 ...
 */
static void
diffFallbackCombReport_r14_7_inherit_TYPE_descriptor(asn_TYPE_descriptor_t *td) {
...
static void
diffFallbackCombReport_r14_7_free(asn_TYPE_descriptor_t *td,
		void *struct_ptr, int contents_only) {
	diffFallbackCombReport_r14_7_inherit_TYPE_descriptor(td);
	td->free_struct(td, struct_ptr, contents_only);
}

static int
diffFallbackCombReport_r14_7_print(asn_TYPE_descriptor_t *td, const void *struct_ptr,
...
diffFallbackCombReport_r14_7_decode_ber(asn_codec_ctx_t *opt_codec_ctx, asn_TYPE_descriptor_t *td,
...
diffFallbackCombReport_r14_7_encode_der(asn_TYPE_descriptor_t *td,
...
static asn_dec_rval_t
diffFallbackCombReport_r14_7_decode_xer(asn_codec_ctx_t *opt_codec_ctx, asn_TYPE_descriptor_t *td,
...
static asn_enc_rval_t
diffFallbackCombReport_r14_7_encode_xer(asn_TYPE_descriptor_t *td, void *structure,
...
static asn_dec_rval_t
diffFallbackCombReport_r14_7_decode_uper(asn_codec_ctx_t *opt_codec_ctx, asn_TYPE_descriptor_t *td,
...
static asn_enc_rval_t
diffFallbackCombReport_r14_7_encode_uper(asn_TYPE_descriptor_t *td,
...
static asn_per_constraints_t asn_PER_type_diffFallbackCombReport_r14_constr_7 GCC_NOTUSED = {
...
static ber_tlv_tag_t asn_DEF_eNB_RequestedParameters_v1430_tags_5[] = {
	(ASN_TAG_CLASS_CONTEXT | (3 << 2)),
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static asn_TYPE_tag2member_t asn_MAP_eNB_RequestedParameters_v1430_tag2el_5[] = {
...
static asn_INTEGER_enum_map_t asn_MAP_diffFallbackCombReport_r14_value2enum_7[] = {
	{ 0,	9,	"supported" }
};
static unsigned int asn_MAP_diffFallbackCombReport_r14_enum2value_7[] = {
	0	/* supported(0) */
};
static asn_INTEGER_specifics_t asn_SPC_diffFallbackCombReport_r14_specs_7 = {
...
static ber_tlv_tag_t asn_DEF_diffFallbackCombReport_r14_tags_7[] = {
...
asn_TYPE_descriptor_t asn_DEF_diffFallbackCombReport_r14_7 = {
	...
	"diffFallbackCombReport-r14",
	diffFallbackCombReport_r14_7_free,
	diffFallbackCombReport_r14_7_print,
	diffFallbackCombReport_r14_7_constraint,
	diffFallbackCombReport_r14_7_decode_ber,
	diffFallbackCombReport_r14_7_encode_der,
	diffFallbackCombReport_r14_7_decode_xer,
	diffFallbackCombReport_r14_7_encode_xer,
	diffFallbackCombReport_r14_7_decode_uper,
	diffFallbackCombReport_r14_7_encode_uper,
	0,	/* Use generic outmost tag fetcher */
...
static asn_TYPE_member_t asn_MBR_RF_Parameters_v1430_1[] = {
...
static int asn_MAP_RF_Parameters_v1430_oms_1[] = { 0, 1, 2, 3, 4 };
static ber_tlv_tag_t asn_DEF_RF_Parameters_v1430_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static asn_TYPE_tag2member_t asn_MAP_RF_Parameters_v1430_tag2el_1[] = {
...
static asn_SEQUENCE_specifics_t asn_SPC_RF_Parameters_v1430_specs_1 = {
