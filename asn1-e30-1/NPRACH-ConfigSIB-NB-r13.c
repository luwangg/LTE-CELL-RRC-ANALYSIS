...
static int
nprach_CP_Length_r13_2_constraint(asn_TYPE_descriptor_t *td, const void *sptr,
 ...
 */
static void
nprach_CP_Length_r13_2_inherit_TYPE_descriptor(asn_TYPE_descriptor_t *td) {
...
static void
nprach_CP_Length_r13_2_free(asn_TYPE_descriptor_t *td,
		void *struct_ptr, int contents_only) {
	nprach_CP_Length_r13_2_inherit_TYPE_descriptor(td);
	td->free_struct(td, struct_ptr, contents_only);
}

static int
nprach_CP_Length_r13_2_print(asn_TYPE_descriptor_t *td, const void *struct_ptr,
...
nprach_CP_Length_r13_2_decode_ber(asn_codec_ctx_t *opt_codec_ctx, asn_TYPE_descriptor_t *td,
...
nprach_CP_Length_r13_2_encode_der(asn_TYPE_descriptor_t *td,
...
static asn_dec_rval_t
nprach_CP_Length_r13_2_decode_xer(asn_codec_ctx_t *opt_codec_ctx, asn_TYPE_descriptor_t *td,
...
static asn_enc_rval_t
nprach_CP_Length_r13_2_encode_xer(asn_TYPE_descriptor_t *td, void *structure,
...
static asn_dec_rval_t
nprach_CP_Length_r13_2_decode_uper(asn_codec_ctx_t *opt_codec_ctx, asn_TYPE_descriptor_t *td,
...
static asn_enc_rval_t
nprach_CP_Length_r13_2_encode_uper(asn_TYPE_descriptor_t *td,
...
static asn_per_constraints_t asn_PER_type_nprach_CP_Length_r13_constr_2 GCC_NOTUSED = {
	{ APC_CONSTRAINED,	 1,  1,  0,  1 }	/* (0..1) */,
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	0, 0	/* No PER value map */
};
static asn_INTEGER_enum_map_t asn_MAP_nprach_CP_Length_r13_value2enum_2[] = {
	{ 0,	8,	"us66dot7" },
	{ 1,	9,	"us266dot7" }
};
static unsigned int asn_MAP_nprach_CP_Length_r13_enum2value_2[] = {
	1,	/* us266dot7(1) */
	0	/* us66dot7(0) */
};
static asn_INTEGER_specifics_t asn_SPC_nprach_CP_Length_r13_specs_2 = {
...
static ber_tlv_tag_t asn_DEF_nprach_CP_Length_r13_tags_2[] = {
...
asn_TYPE_descriptor_t asn_DEF_nprach_CP_Length_r13_2 = {
	...
	"nprach-CP-Length-r13",
	nprach_CP_Length_r13_2_free,
	nprach_CP_Length_r13_2_print,
	nprach_CP_Length_r13_2_constraint,
	nprach_CP_Length_r13_2_decode_ber,
	nprach_CP_Length_r13_2_encode_der,
	nprach_CP_Length_r13_2_decode_xer,
	nprach_CP_Length_r13_2_encode_xer,
	nprach_CP_Length_r13_2_decode_uper,
	nprach_CP_Length_r13_2_encode_uper,
...
static asn_TYPE_member_t asn_MBR_NPRACH_ConfigSIB_NB_r13_1[] = {
...
static int asn_MAP_NPRACH_ConfigSIB_NB_r13_oms_1[] = { 1 };
static ber_tlv_tag_t asn_DEF_NPRACH_ConfigSIB_NB_r13_tags_1[] = {
