...
static int
rrc_SuspendIndication_r13_2_constraint(asn_TYPE_descriptor_t *td, const void *sptr,
 ...
 */
static void
rrc_SuspendIndication_r13_2_inherit_TYPE_descriptor(asn_TYPE_descriptor_t *td) {
...
static void
rrc_SuspendIndication_r13_2_free(asn_TYPE_descriptor_t *td,
		void *struct_ptr, int contents_only) {
	rrc_SuspendIndication_r13_2_inherit_TYPE_descriptor(td);
	td->free_struct(td, struct_ptr, contents_only);
}

static int
rrc_SuspendIndication_r13_2_print(asn_TYPE_descriptor_t *td, const void *struct_ptr,
...
rrc_SuspendIndication_r13_2_decode_ber(asn_codec_ctx_t *opt_codec_ctx, asn_TYPE_descriptor_t *td,
...
rrc_SuspendIndication_r13_2_encode_der(asn_TYPE_descriptor_t *td,
...
static asn_dec_rval_t
rrc_SuspendIndication_r13_2_decode_xer(asn_codec_ctx_t *opt_codec_ctx, asn_TYPE_descriptor_t *td,
...
static asn_enc_rval_t
rrc_SuspendIndication_r13_2_encode_xer(asn_TYPE_descriptor_t *td, void *structure,
...
static asn_dec_rval_t
rrc_SuspendIndication_r13_2_decode_uper(asn_codec_ctx_t *opt_codec_ctx, asn_TYPE_descriptor_t *td,
...
static asn_enc_rval_t
rrc_SuspendIndication_r13_2_encode_uper(asn_TYPE_descriptor_t *td,
...
static asn_per_constraints_t asn_PER_type_rrc_SuspendIndication_r13_constr_2 GCC_NOTUSED = {
	{ APC_CONSTRAINED,	 0,  0,  0,  0 }	/* (0..0) */,
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	0, 0	/* No PER value map */
};
static asn_INTEGER_enum_map_t asn_MAP_rrc_SuspendIndication_r13_value2enum_2[] = {
	{ 0,	4,	"true" }
};
static unsigned int asn_MAP_rrc_SuspendIndication_r13_enum2value_2[] = {
	0	/* true(0) */
};
static asn_INTEGER_specifics_t asn_SPC_rrc_SuspendIndication_r13_specs_2 = {
...
static ber_tlv_tag_t asn_DEF_rrc_SuspendIndication_r13_tags_2[] = {
...
asn_TYPE_descriptor_t asn_DEF_rrc_SuspendIndication_r13_2 = {
	...
	"rrc-SuspendIndication-r13",
	rrc_SuspendIndication_r13_2_free,
	rrc_SuspendIndication_r13_2_print,
	rrc_SuspendIndication_r13_2_constraint,
	rrc_SuspendIndication_r13_2_decode_ber,
	rrc_SuspendIndication_r13_2_encode_der,
	rrc_SuspendIndication_r13_2_decode_xer,
	rrc_SuspendIndication_r13_2_encode_xer,
	rrc_SuspendIndication_r13_2_decode_uper,
	rrc_SuspendIndication_r13_2_encode_uper,
...
static asn_TYPE_member_t asn_MBR_RRCConnectionReject_v1320_IEs_1[] = {
...
static int asn_MAP_RRCConnectionReject_v1320_IEs_oms_1[] = { 0, 1 };
static ber_tlv_tag_t asn_DEF_RRCConnectionReject_v1320_IEs_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static asn_TYPE_tag2member_t asn_MAP_RRCConnectionReject_v1320_IEs_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* rrc-SuspendIndication-r13 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 } /* nonCriticalExtension */
};
static asn_SEQUENCE_specifics_t asn_SPC_RRCConnectionReject_v1320_IEs_specs_1 = {
