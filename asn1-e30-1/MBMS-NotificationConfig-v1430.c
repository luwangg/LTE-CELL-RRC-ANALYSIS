...
static int
memb_notificationSF_Index_v1430_constraint_1(asn_TYPE_descriptor_t *td, const void *sptr,
...
static asn_per_constraints_t asn_PER_memb_notificationSF_Index_v1430_constr_2 GCC_NOTUSED = {
	{ APC_CONSTRAINED,	 2,  2,  7,  10 }	/* (7..10) */,
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	0, 0	/* No PER value map */
};
static asn_TYPE_member_t asn_MBR_MBMS_NotificationConfig_v1430_1[] = {
...
static ber_tlv_tag_t asn_DEF_MBMS_NotificationConfig_v1430_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static asn_TYPE_tag2member_t asn_MAP_MBMS_NotificationConfig_v1430_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 } /* notificationSF-Index-v1430 */
};
static asn_SEQUENCE_specifics_t asn_SPC_MBMS_NotificationConfig_v1430_specs_1 = {
