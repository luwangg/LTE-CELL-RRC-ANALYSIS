...
static asn_per_constraints_t asn_PER_type_SC_MCCH_MessageType_NB_constr_1 GCC_NOTUSED = {
...
static asn_TYPE_member_t asn_MBR_SC_MCCH_MessageType_NB_1[] = {
...
static asn_TYPE_tag2member_t asn_MAP_SC_MCCH_MessageType_NB_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* c1 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 } /* messageClassExtension */
};
static asn_CHOICE_specifics_t asn_SPC_SC_MCCH_MessageType_NB_specs_1 = {
