...
static asn_TYPE_member_t asn_MBR_MeasResultCBR_r14_1[] = {
...
static int asn_MAP_MeasResultCBR_r14_oms_1[] = { 2 };
static ber_tlv_tag_t asn_DEF_MeasResultCBR_r14_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static asn_TYPE_tag2member_t asn_MAP_MeasResultCBR_r14_tag2el_1[] = {
...
static asn_SEQUENCE_specifics_t asn_SPC_MeasResultCBR_r14_specs_1 = {
