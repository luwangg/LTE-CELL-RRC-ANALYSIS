...
static ber_tlv_tag_t asn_DEF_UplinkPowerControlDedicated_NB_r13_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static asn_TYPE_tag2member_t asn_MAP_UplinkPowerControlDedicated_NB_r13_tag2el_1[] = {
