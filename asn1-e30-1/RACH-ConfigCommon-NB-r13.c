...
static int
memb_connEstFailOffset_r13_constraint_1(asn_TYPE_descriptor_t *td, const void *sptr,
...
static asn_per_constraints_t asn_PER_memb_connEstFailOffset_r13_constr_5 GCC_NOTUSED = {
	{ APC_CONSTRAINED,	 4,  4,  0,  15 }	/* (0..15) */,
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	0, 0	/* No PER value map */
};
static asn_TYPE_member_t asn_MBR_RACH_ConfigCommon_NB_r13_1[] = {
	...
	{ ATF_POINTER, 1, offsetof(struct RACH_ConfigCommon_NB_r13, connEstFailOffset_r13),
...
static int asn_MAP_RACH_ConfigCommon_NB_r13_oms_1[] = { 3 };
static ber_tlv_tag_t asn_DEF_RACH_ConfigCommon_NB_r13_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static asn_TYPE_tag2member_t asn_MAP_RACH_ConfigCommon_NB_r13_tag2el_1[] = {
...
static asn_SEQUENCE_specifics_t asn_SPC_RACH_ConfigCommon_NB_r13_specs_1 = {
